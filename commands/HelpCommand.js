...
const HelpCommand = (my_phone_number, username, to_phone_number) => {
  let messages_list = [
    `Hola 👋 ${username} soy Telebot 🤖 el asistente virtual de Telemark y he venido a ayudarte, 
    a continuación te muestro los comandos disponibles y su descripción, recuerda agregar '!' antes
    de cada comando: `,
